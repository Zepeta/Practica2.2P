...
class Aestrella:
    ...
    def a_estrella(self, posicion_inicial, posicion_final, costos):
        self.costos = costos
        nodos_abiertos_aux = []
        nodos_cerrados = []
        nodos_abiertos = []
        aux = []
        h_0 =  self.calcular_heurisitica(posicion_inicial,posicion_inicial,posicion_final,0)
        aux.append((posicion_inicial,h_0[0],0))
        ...
        return nodos_abiertos,nodos_cerrados, ruta_optima
